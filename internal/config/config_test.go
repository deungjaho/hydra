...
func TestDefault(t *testing.T) {
	...
	// MonitoredModels is nil by default — "monitor all" mode.
	// An empty list means quota protection checks all dynamically
	// fetched models, not just a hardcoded subset.
